<div class="row">
	<div class="col-md-12">
		...
		<div class="box box-success box-solid">
			...
			<form id="formID" role="form" action="<?=base_url('siswa/ajax_save'); ?>" method="post">
			...
			<div class="box-footer">
				...
				<button type="submit" class="btn btn-sm btn-flat btn-jk" ><i class="fa fa-save"></i> Simpan & Keluar</button>
